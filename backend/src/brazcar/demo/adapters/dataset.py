...
run (`workers: 1`): sign-up, deleting the account it just created, changing its password, and
editing its profile, each taking the phone at `journey * projects + project`. A
